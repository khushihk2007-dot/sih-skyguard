...
const DEMO_STATIONS: Station[] = [
  { id: "AWS-DEL-001", name: "New Delhi – Safdarjung",  lat: 28.5849, lng: 77.2083, status: "NORMAL",        severity: "LOW", t_aws: 34.2, t_witness: 34.0, t_predicted: 33.8, is_imputed: false, t_imputed: null, original_t_aws: 34.2, reason: null, lastUpdated: null },
  { id: "AWS-MUM-001", name: "Mumbai – Colaba",         lat: 18.9067, lng: 72.8147, status: "PRIMARY_DRIFT", severity: "HIGH", t_aws: 38.7, t_witness: 31.5, t_predicted: 31.2, is_imputed: true, t_imputed: 31.4, original_t_aws: 38.7, reason: "Official AWS sensor has drifted.", lastUpdated: new Date().toISOString() },
  { id: "AWS-BLR-001", name: "Bengaluru – HAL Airport",  lat: 12.9499, lng: 77.6681, status: "NORMAL",        severity: "LOW", t_aws: 26.1, t_witness: 26.4, t_predicted: 26.0, is_imputed: false, t_imputed: null, original_t_aws: 26.1, reason: null, lastUpdated: null },
  { id: "AWS-CHN-001", name: "Chennai – Nungambakkam",   lat: 13.0604, lng: 80.2496, status: "TRUE_EXTREME",  severity: "CRITICAL", t_aws: 42.3, t_witness: 42.1, t_predicted: 36.5, is_imputed: false, t_imputed: null, original_t_aws: 42.3, reason: "Genuine extreme heatwave detected.", lastUpdated: new Date().toISOString() },
  { id: "AWS-KOL-001", name: "Kolkata – Dum Dum",        lat: 22.6520, lng: 88.4463, status: "WITNESS_FAULT", severity: "HIGH", t_aws: 33.0, t_witness: 41.2, t_predicted: 32.8, is_imputed: false, t_imputed: null, original_t_aws: 33.0, reason: "Witness node is faulty.", lastUpdated: new Date().toISOString() },
  { id: "AWS-HYD-001", name: "Hyderabad – Begumpet",     lat: 17.4432, lng: 78.4674, status: "NORMAL",        severity: "LOW", t_aws: 30.5, t_witness: 30.3, t_predicted: 30.1, is_imputed: false, t_imputed: null, original_t_aws: 30.5, reason: null, lastUpdated: null },
  { id: "AWS-JAI-001", name: "Jaipur – Sanganer",        lat: 26.8242, lng: 75.8123, status: "NORMAL",        severity: "LOW", t_aws: 36.8, t_witness: 36.5, t_predicted: 36.2, is_imputed: false, t_imputed: null, original_t_aws: 36.8, reason: null, lastUpdated: null },
  { id: "AWS-LKO-001", name: "Lucknow – Amausi",         lat: 26.7606, lng: 80.8893, status: "PRIMARY_DRIFT", severity: "MEDIUM", t_aws: 40.1, t_witness: 35.4, t_predicted: 35.0, is_imputed: true, t_imputed: 35.2, original_t_aws: 40.1, reason: "AWS sensor drifted.", lastUpdated: new Date().toISOString() },
  { id: "AWS-PAT-001", name: "Patna – Bihar Sharif",     lat: 25.6093, lng: 85.1376, status: "NORMAL",        severity: "LOW", t_aws: 33.7, t_witness: 33.5, t_predicted: 33.2, is_imputed: false, t_imputed: null, original_t_aws: 33.7, reason: null, lastUpdated: null },
  { id: "AWS-GUW-001", name: "Guwahati – Borjhar",       lat: 26.1013, lng: 91.5860, status: "TRUE_EXTREME",  severity: "CRITICAL", t_aws: 38.9, t_witness: 39.1, t_predicted: 32.0, is_imputed: false, t_imputed: null, original_t_aws: 38.9, reason: "Extreme event detected.", lastUpdated: new Date().toISOString() },
  { id: "AWS-TRV-001", name: "Thiruvananthapuram",       lat: 8.5241,  lng: 76.9366, status: "NORMAL",        severity: "LOW", t_aws: 29.8, t_witness: 29.6, t_predicted: 29.5, is_imputed: false, t_imputed: null, original_t_aws: 29.8, reason: null, lastUpdated: null },
  { id: "AWS-PNQ-001", name: "Pune – Lohegaon",          lat: 18.5822, lng: 73.9197, status: "NORMAL",        severity: "LOW", t_aws: 28.4, t_witness: 28.2, t_predicted: 28.0, is_imputed: false, t_imputed: null, original_t_aws: 28.4, reason: null, lastUpdated: null },
];
